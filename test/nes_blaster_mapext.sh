...
python3 ../nes_blaster_mapext.py \
    -v -u ../test-out/usb0.png -s ../test-out/sb0.png \
    -b ../test-out/blocks0.png ../test-in/blastermaster.nes
echo

echo "=== USB/SB/blocks (no map) of map 8, US ==="
python3 ../nes_blaster_mapext.py \
    -n8 -u ../test-out/usb8.png -s ../test-out/sb8.png \
    -b ../test-out/blocks8.png ../test-in/blastermaster.nes
echo
...
do
    python3 ../nes_blaster_mapext.py \
        -n$i -m ../test-out/map$i.png ../test-in/blastermaster.nes
done
echo
