...
echo "=== Encoding ==="
python3 ../nes_chr_encode.py --verbose                             ../test-in/smb1-chr.png           ../test-out/smb1a.chr
...
python3 ../nes_chr_encode.py --palette 000000 111111 222222 33333  ../test-in/smb1-chr.png ../test-out/invalid1.chr
python3 ../nes_chr_encode.py --palette 000000 111111 222222 33333g ../test-in/smb1-chr.png ../test-out/invalid2.chr
python3 ../nes_chr_encode.py --palette 000000 111111 222222 000000 ../test-in/smb1-chr.png ../test-out/invalid3.chr
python3 ../nes_chr_encode.py --palette 000000 696969 420420 ffffff ../test-in/smb1-chr.png ../test-out/invalid4.chr
